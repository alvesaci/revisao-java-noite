...
public class TestaContaCorrente {
	...
	public static void main(String[] args) {
		Cliente natan = new Cliente("Natan", "111.222.333-12", 25);
		...
		Cliente jackson = new Cliente("jackson", "121.232.353-12", 43);
		ContaCorrente contaJackson = new ContaCorrente();
		contaJackson.setCliente(jackson);
		contaJackson.setAgencia("986-5");
...
//		contaNatan.transfere(200f, conJackson);
